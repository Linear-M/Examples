 ...
 * @author Rick
 */
public class RimmingtonClay extends AbstractMiningStrategy implements PaintListener {
    private static final RSTile BANK_LOCATION = new RSTile(3013, 3356);
    private static final RSTile MINING_SITE = new RSTile(2986, 3240);
    ...
    public String toString() {
        return "Clay mining at Rimmington mine.";
    }
